...
class StatsOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Total Profits (Income: ' . number_format($getYearIncome) . ')', number_format($getYearIncome - $getYearCashOut))->description("Total profits in this year")->descriptionIcon('heroicon-m-information-circle', IconPosition::Before),
